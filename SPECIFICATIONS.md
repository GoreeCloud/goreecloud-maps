...
1. Repository/product foundation and architecture contracts.
2. Web map shell with Glaze UI 2.0 semantics and replaceable map-style provider.
3. Identity-backed multi-user API and PostGIS schema for saved places/collections.
4. Place discovery/geocoding provider and Search interoperability.
5. Route planning provider and directions UI.
